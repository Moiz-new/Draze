...
import 'AddRoomImagesScreen.dart';
...
class _AddRoomScreenState extends State<AddRoomScreen> {
  ...
  // NEW: Added controllers for security deposit and notice period
  ...
  Future<void> _submitForm() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        // NEW: Parse security deposit and notice period
        final securityDeposit = double.tryParse(_securityDepositController.text) ?? 0.0;
        final noticePeriod = int.tryParse(_noticePeriodController.text) ?? 0;
        ...
        final roomData = {
          ...
          'securityDeposit': securityDeposit, // NEW: Added security deposit
          'noticePeriod': noticePeriod, // NEW: Added notice period
          'facilities': _buildFacilitiesObject(),
        };

        final responseData = await _roomService.addRoom(
          propertyId: widget.propertyId,
          roomData: roomData,
        );

        if (responseData != null && mounted) {
          // Extract the roomId from the first added room
          final roomId = responseData['addedRooms'][0]['roomId'];
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // Pricing & Capacity (UPDATED SECTION)
              _buildSectionCard(
                ...
                child: Column(
                  children: [
                    ...
                    _buildEnhancedTextField(
                      ...
                      label: 'Notice Period',
                      hint: 'Enter notice period in days',
