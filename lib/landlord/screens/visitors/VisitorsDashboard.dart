...
import '../../providers/VisitorsDashboardProvider.dart';

class VisitorsDashboard extends StatefulWidget {
  const VisitorsDashboard({Key? key, required GlobalKey<ScaffoldState> scaffoldKey}) : super(key: key);
...
class _VisitorsDashboardState extends State<VisitorsDashboard> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<VisitorsDashboardProvider>().fetchVisitorsData();
    });
  }
    ...
    return ScreenUtilInit(
      ...
      builder: (context, child) {
        return Scaffold(
          ...
          body: Consumer<VisitorsDashboardProvider>(
  ...
  Widget _buildErrorCard(VisitorsDashboardProvider provider) {
    return Container(
  ...
  Widget _buildTotalCard(VisitorsDashboardProvider provider) {
