...
import 'package:draze/landlord/widgets/coments.dart';
...
class LandlordReelVideoWidget extends ConsumerStatefulWidget {
  final ReelModel reel;
  final bool isActive;

  const LandlordReelVideoWidget({
    super.key,
    required this.reel,
  ...
  @override
  ConsumerState<LandlordReelVideoWidget> createState() =>
      _LandlordReelVideoWidgetState();
}

class _LandlordReelVideoWidgetState
    extends ConsumerState<LandlordReelVideoWidget>
  ...
  @override
  void didUpdateWidget(LandlordReelVideoWidget oldWidget) {
  ...
  void _showCommentsBottomSheet(BuildContext context) {
    showModalBottomSheet(
      ...
      builder: (context) => LandlordCommentsBottomSheet(reel: widget.reel),
    );
  }
