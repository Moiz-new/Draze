class RentProperty {
  ...
  factory RentProperty.fromJson(Map<String, dynamic> json) {
    return RentProperty(
      id: json['id'] ?? '',
      title: json['title'] ?? '',
      ...
      availableFrom: DateTime.parse(
        json['availableFrom'] ?? DateTime.now().toIso8601String(),
      ),
      ...
      electricityType: json['electricityType'] ?? 'separate',
      waterSupply: json['waterSupply'] ?? '24/7',
      hasBalcony: json['hasBalcony'] ?? false,
      hasGarden: json['hasGarden'] ?? false,
      isVerified: json['isVerified'] ?? false,
      leaseDurationMonths: json['leaseDurationMonths'] ?? 12,
    );
  }
}
