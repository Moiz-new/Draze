...
class RentTourRequestBottomSheet extends StatefulWidget {
  final String propertyId;

  const RentTourRequestBottomSheet({required this.propertyId});

  @override
  State<RentTourRequestBottomSheet> createState() =>
      _RentTourRequestBottomSheetState();
}

class _RentTourRequestBottomSheetState extends State<RentTourRequestBottomSheet>
