...
class SellerAllVisitorsProvider extends ChangeNotifier {
  List<SellerVisitorModel> _visitors = [];
  ...
  List<SellerVisitorModel> get visitors => _visitors;
  ...
  List<SellerVisitorModel> get filteredVisitors {
  ...
  Future<void> fetchAllVisitors() async {
    ...
    try {
      ...
      final uri = Uri.parse('$base_url/api/seller/getallvisits');
          ...
          if (visitsData != null && visitsData is List) {
            _visitors =
                visitsData
                    ...
                    .map((visitor) {
                      try {
                        return SellerVisitorModel.fromJson(
  ...
  Future<bool> confirmVisit({
    ...
    try {
      ...
      final response = await http
          .put(
            Uri.parse('$base_url/api/seller/confirm-visit/$visitorId'),
            headers: {
              'Authorization': 'Bearer $token',
              'Content-Type': 'application/json',
            },
      ...
      if (response.statusCode == 200) {
        ...
        if (data['success'] == true) {
          ...
          if (visitData != null && visitData is Map<String, dynamic>) {
            try {
              final updatedVisitor = SellerVisitorModel.fromJson(visitData);
  ...
  Future<bool> cancelVisit({
    ...
    try {
      ...
      final response = await http
          .put(
            Uri.parse('$base_url/api/seller/cancel-visit/$visitorId'),
            headers: {
              'Authorization': 'Bearer $token',
              'Content-Type': 'application/json',
            },
